Photonic Quantum Measurement and Control System Communication Protocol Document
===============================================================================
...
* **ConvertQProg** ("String"): [Required] Quantum program; the instructions to be executed by the measurement and control system (Photonic platform specific format).
...
The basic gate types for the Photonic platform differ from those of the superconducting platform. The "ConvertQProg" field maintains a dedicated format for the Photonic platform and is not forced to be consistent with the superconducting platform.

Supported photonic quantum gates include: X, Y, Z, H, T, S, X1, Y1, Z1, CR, RZ, RY, RX, U1, U2, U3, U4, TOFFOLI, CNOT, CZ, SWAP, CCNOT, MEASURE, etc.

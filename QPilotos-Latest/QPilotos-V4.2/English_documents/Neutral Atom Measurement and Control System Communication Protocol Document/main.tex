...
\title{\textbf{Neutral Atom Measurement and Control System Communication Protocol Document}}
\author{OriginQ}
\date{\today}
...
\begin{itemize}
    ...
    \item \textbf{ConvertQProg} (\texttt{String}): [Required] Quantum program; the instructions to be executed by the measurement and control system (Neutral Atom platform specific format).
...
The basic gate types for the Neutral Atom platform differ from those of the superconducting platform. The \texttt{ConvertQProg} field maintains a dedicated format for the Neutral Atom platform and is not forced to be consistent with the superconducting platform.

Ion Trap Measurement and Control System Communication Protocol Document
=======================================================================
...
* **ConvertQProg** ("String"): [Required] Quantum program; the instructions to be executed by the measurement and control system (Ion Trap platform specific format).
...
The basic gate types for the Ion Trap platform differ from those of the superconducting platform. The "ConvertQProg" field maintains a dedicated format for the Ion Trap platform and is not forced to be consistent with the superconducting platform.
